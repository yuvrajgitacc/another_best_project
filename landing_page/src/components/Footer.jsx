  ...
  const footerData = [
    {
      title: "Platform",
      links: [
        { label: "Home", action: () => onNavigate && onNavigate('landing') },
        { label: "Features", action: () => onNavigate && onNavigate('features') },
        { label: "Pricing", action: () => onNavigate && onNavigate('pricing') },
        { label: "How it Works", action: () => onNavigate && onNavigate('how-it-works') }
      ]
    },
    {
      title: "Products",
    ...
    <footer className="footer">
      ...
      >
        <div className="footer-copyright">
          © {new Date().getFullYear()} SevaSetu. Built with ❤️ for social impact.
        </div>
